...
public class DIPTehtava {
    ...
    public static void main(final String[] args) {
        ...
        String decodedStr = print.printString("Järjestelmän autolla on ajettu keskimäärin vuodessa: ");

        System.out.println(decodedStr  +businessLuokkaAutolle.laskeKeskimaaraisetKilometritPerVuosi() + " kilometriä");
...
class DIPConfigurator {
    ...
    public static BusinessLuokka konfiguraatioAutolle() {
        ...
        final Ajoneuvo ajoneuvo = new Auto(56000, 2018, true);
    ...
    public static BusinessLuokka konfiguraatioMoottoripyorille() {
        ...
        final Ajoneuvo ajoneuvo = new Moottoripyora(20500, 2015, false);
